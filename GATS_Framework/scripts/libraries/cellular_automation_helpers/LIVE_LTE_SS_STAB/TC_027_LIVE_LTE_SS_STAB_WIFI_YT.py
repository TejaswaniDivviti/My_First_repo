# Stream youtube in DUT after connecting to Wifi
import time
...
class perform_wifi_youtube():
    ...
    def execute_wifi_youtube(self):
        ...
        status, msg = ad.wifi_enable(
            self.Data['serialId'],
            self.Data['testcase_config'][self.tst]['ssid'],
        ...
        status, msg = ad.stream_video(deviceId=self.Data['serialId'], exec_status="START",
        ...
        status, msg = ad.stream_video(deviceId=self.Data['serialId'], exec_status="STOP",
                                      http_link=self.Data['testcase_config'][self.tst]['youtube_http_link'])
        if not status:
            log.info("Streaming failed")
            return False, "not executed"
